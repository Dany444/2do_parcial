...
function ejecutar(){
    ...
    if (v1.length==0){
        ...
        document.f_segundo_parcial.nombre.style.background="#e8f0fd";
        ...
        if(v2.length==0){
            ...
            document.f_segundo_parcial.ap.style.background="#e8f0fd";
            ...
            if(v3.length==0){
                ...
                document.f_segundo_parcial.am.style.background="#e8f0fd";
                ...
                if(v4.length==0){
                    ...
                    document.f_segundo_parcial.fecha.style.background="#e8f0fd";
